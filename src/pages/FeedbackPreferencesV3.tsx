...
import LivePreview from "@/components/feedback-preferences/LivePreview"
import MobileNavbar from "@/components/dashboard/MobileNavBar"
import ChatButton from "@/components/dashboard/ChatButton"

// V3: Live Preview Snippet

const FeedbackPreferencesV3 = () => {
  ...
  // Update tone and detail level when persona changes
  useEffect(() => {
    switch (persona) {
      case "motivator":
        setTone("encouraging")
    ...
    <div className="min-h-screen bg-[#f8f9fa] pb-20">
      ...
      <div className="container max-w-md mx-auto px-4 py-6">
        <div className="space-y-8">
          <PersonaSelector selectedPersona={persona} onChange={setPersona} showDescription={false} />

          <LivePreview persona={persona} tone={tone} detailLevel={detailLevel} />
...
export default FeedbackPreferencesV3
