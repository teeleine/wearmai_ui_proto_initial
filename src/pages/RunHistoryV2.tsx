...
import SectionHeader from "@/components/run-history/SectionHeader"
import FilterButton from "@/components/run-history/FilterButton"
import MobileNavbar from "@/components/dashboard/MobileNavBar"

// Sample run data grouped by time periods
const runGroups = [
  {
    title: "This Week",
    runs: [
