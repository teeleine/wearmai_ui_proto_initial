...
const DataExplorerV3b: React.FC = () => {
  // Sample run date
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa]">
      ...
      <div className="container max-w-md mx-auto px-4 py-4 pb-20">
        ...
        <motion.div className="mt-6" variants={containerVariants} initial="hidden" animate="show">
          ...
          {/* Move the interaction tip here, right under the chart */}
          <motion.div variants={itemVariants}>
            <div className="bg-[#f0f7ff] p-3 rounded-md mb-6">
              <p className="text-sm text-[#42b4f7] font-medium">Interaction Tip</p>
              <p className="text-xs text-gray-600 mt-1">
                Tap directly on the chart to get an AI-powered explanation of your biomechanical data at specific points
                in your run.
              </p>
            </div>
          </motion.div>
...
export default DataExplorerV3b
